...
<body>
    ...
    <div class="wrapper">
			...
			<div class="fixed-sidebar-left">
                ...
                <li>
                    <a href="javascript:void(0);" data-toggle="collapse" data-target="#ui_tr"><i class="icon-vector mr-10"></i>Orders <span class="pull-right"><i class="fa fa-fw fa-angle-down"></i></span></a>
